...
def base(title: str, body: str, *, nav_home: str = "", nav_dash: str = "",
         run_state: str = "", model_name: str = "") -> str:
    """Wrap a body fragment in the page shell. nav_home/nav_dash are the 'active'
    class for the corresponding header link; run_state is a small status string;
    model_name is the LLM model shown in the header bar (config.MODEL_NAME)."""
    return render("base.html",
                  title=html.escape(title), body=body,
                  nav_home=nav_home, nav_dash=nav_dash,
